...
public class LiveTool3 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if(rw) {
            System.out.println("正在完成任务要求 收到价值10电池的礼物...");
            String msg;
            ...
            msg = FFL.sendGold(COOKIE2,uid2,ruid,roomid,CSRF2,"31039","4","100");
            if (msg.equals("0")){
                msg = "成功";
            }
            System.out.println( name2 + "：牛哇牛哇*4 赠送" + msg +",更换账号发送下一条...");
            msg = FFL.sendGold(COOKIE3,uid3,ruid,roomid,CSRF3,"31039","4","100");
            if (msg.equals("0")) {
                msg = "成功";
            }
            System.out.println( name3 + "：牛哇牛哇*4 赠送" + msg +",即将完成任务...");
            Thread.sleep(5000);
        }
