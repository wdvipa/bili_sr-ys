...
public class LiveTool {
	...
	private static final String task_name="%E7%B4%AF%E8%AE%A13%E5%A4%A9%E5%AE%8C%E6%88%90%E5%85%A8%E9%83%A8%E2%80%9C%E6%AF%8F%E6%97%A5%E7%9B%B4%E6%92%AD%E4%BB%BB%E5%8A%A1%E2%80%9D";
	private static final String reward_name="%E6%98%9F%E7%90%BC*360";
	...
	public static void main(String[] args) throws IOException,InterruptedException {
		...
		while (a == 1) {
			...
			if (curTime1.getHours() == 23) {
				...
				System.out.println(dateFormat1.format(new Date()) + "超过时间");
		...
		Map<String, Object> rewardMap = (Map<String, Object>) taskInfoMap.get("reward_info");
		Map<String, Object> actMap = (Map<String, Object>) ((Map<String, Object>) mmap.get("data")).get("act_info");
